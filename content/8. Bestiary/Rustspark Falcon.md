...
> ## **Rustspark Falcon**
> 
> ![[z_Assets/Rustspark_Falcon.webp]]
> 
> ## - Facts -
> | Type | Name |
> | ---- | ---- |
> | **Aliases** | Blinking Falcon |
> | **Category** | Animal |
> | **Rarity** | Uncommon (-4) |
> | **Habitat** | Grasslands,<br>Plains,<br>Foothills,<br>Mountains |
> | **Size** | Small to Medium |
> | **Social Structure** | Solitary |
> | **Intellect** | Low to Average |
> | **Speech** | No |
> | **Diet** | Avivore |
> | **Behavior** | Frightful |
> | **Origin** | Natural,<br>Essence Influenced |
> | **Traits** | Light Flash,<br>Short-Distance Teleportation |

<br>

> [!quote| author clean] *"The Rustspark Falcon is the very embodiment of lightning in flight—swift, dazzling, and near impossible to counter once it sets its eyes on a target."*
...
**Light Flash:**
- The falcon can generate a sudden, blinding flash of light that disorients both prey and potential predators. This flash is rust-colored, resembling a metallic sheen when observed from a distance. It is theorized that this trait evolved as a defensive measure and as an enhancement to its hunting strategy.

**Short-Distance Teleportation:**
- The falcon possesses the rare ability to teleport short distances, reappearing in a burst of rust-hued light. It typically uses this ability during its high-speed dives, teleporting just in front of its target to secure a kill with precision. This trait is a clear indication of the Mirror's lingering influence on its evolutionary path.
...
>> 
>>**Feathers**
>>- Used by some alchemists to create potions of stealth, teleportation and generally enhance [Aethermancy](3.%20The%20Disciplines%20&%20Aspects.md#Aethermancy)
>>- Known for their luminescent properties, they are used in ceremonial garments and by mages for essence studies.
>>
>>**Flash-Essence Core**
>>- A small, energy-infused gland that can be refined for light-based enchantments.
>
>> [!error| no-i ttl-c] Lore & Myths:
>> 
>>**Messenger of the gods**
>>
>>- Some [Anthalyr tribes](../4.%20The%20Races/5.%20The%20Anthalyr/1.%20Lore.md) revere the Rustspark Falcon as an avatar of a minor storm deity, believing its flashes are signs of favor or warning.
