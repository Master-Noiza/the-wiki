...
- Cost of spells, including "Alternative Ability" (Homebrew - Comments?) can not exceed cost of Weaving Empowerment
...
**Mandatory Enhancements & Limitations (Shamanism & Essence Carving varies, see there):**
  ...
  - **Magical** (-10%),
  - **Costs ER** (Variable (-5% per ER, 1 ER per 10 CP base cost),
  - **Requires Gesture** (-10%),
  - **Requires Word** (-10%),
  - **Transcribable** (+5%),
  - **Attracts Threats** (-5%),
  - **Corrupting** (1 Corruption point/Energy spend),
  - **Backlash** (only on failure, HT to resist, Effect for MoE seconds, GM rolls on Table, -8%)
...
**Mandatory Enhancements & Limitations (Shamanism):**
  - **Requires Skill-Roll (associated Aspect-skill)** (-10%),
  - **Magical** (-10%),
  - **Costs HP** (Variable (-10% per HP, 2 HP per 10 CP base cost),
  - **Requires Gesture** (-10%),
  - **Requires Word** (-10%),
  - **Transcribable** (+5%),
  - **Attracts Threats** (-10%),
...
- **Attracts Threats** (-5%),
- **Costs ER** (Variable, 1 ER per 10 CP base Cost)
...
- **Backlash** (only on failure, HT to resist, Effect for MoE seconds, GM rolls on Table, -8%),
- **Corrupting** (1 Corruption point/2 Energy spend),
- Finally *after all other calculations* every spell gets **Alternative Ability** (Costs 1/5th)
<br>
---
